...
func (x *IntegratedDecided) Reset() {
	*x = IntegratedDecided{}
...
func (x *IntegratedDecided) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IntegratedDecided) ProtoMessage() {}

func (x *IntegratedDecided) ProtoReflect() protoreflect.Message {
	mi := &file_protocol_messages_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IntegratedDecided.ProtoReflect.Descriptor instead.
func (*IntegratedDecided) Descriptor() ([]byte, []int) {
	return file_protocol_messages_proto_rawDescGZIP(), []int{13}
}

func (x *IntegratedDecided) GetInstanceId() []byte {
	if x != nil {
		return x.InstanceId
	}
	return nil
...
func (x *IntegratedDecided) GetDecision() bool {
	if x != nil {
		return x.Decision
	}
	return false
...
func (x *Message) GetProof() *Proof {
	if x != nil {
		if x, ok := x.Payload.(*Message_Proof); ok {
			return x.Proof
		}
	}
	return nil
...
func (x *Message) GetIntegratedDecided() *IntegratedDecided {
	if x != nil {
		if x, ok := x.Payload.(*Message_IntegratedDecided); ok {
			return x.IntegratedDecided
		}
	}
	return nil
}
...
type Message_Proof struct {
	Proof *Proof `protobuf:"bytes,13,opt,name=proof,proto3,oneof"`
}

type Message_IntegratedDecided struct {
	// CDCP
	IntegratedDecided *IntegratedDecided `protobuf:"bytes,14,opt,name=integrated_decided,json=integratedDecided,proto3,oneof"`
}

type Message_WsDecided struct {
	WsDecided *WSDecided `protobuf:"bytes,15,opt,name=ws_decided,json=wsDecided,proto3,oneof"`
}
...
func (*Message_Proof) isMessage_Payload() {}

func (*Message_IntegratedDecided) isMessage_Payload() {}
...
const file_protocol_messages_proto_rawDesc = "" +
	"\n" +
	"\x17protocol_messages.proto\x12\acompose\"\xa0\x01\n" +
	...
	"\n" +
	"proof_data\x18\x03 \x01(\fR\tproofData\"P\n" +
	"\x11IntegratedDecided\x12\x1f\n" +
	"\vinstance_id\x18\x01 \x01(\fR\n" +
	"instanceId\x12\x1a\n" +
	...
	"\vinstance_id\x18\x01 \x01(\fR\n" +
	"instanceId\x12\x1a\n" +
	"\bdecision\x18\x02 \x01(\bR\bdecision\"\xb5\x06\n" +
	"\aMessage\x12\x1b\n" +
	...
	"\x05proof\x18\r \x01(\v2\x0e.compose.ProofH\x00R\x05proof\x12K\n" +
	"\x12integrated_decided\x18\x0e \x01(\v2\x1a.compose.IntegratedDecidedH\x00R\x11integratedDecided\x123\n" +
	"\n" +
	"ws_decided\x18\x0f \x01(\v2\x12.compose.WSDecidedH\x00R\twsDecidedB\t\n" +
...
var file_protocol_messages_proto_goTypes = []any{
	...
	(*IntegratedDecided)(nil),  // 13: compose.IntegratedDecided
...
var file_protocol_messages_proto_depIdxs = []int32{
	...
	12, // 13: compose.Message.proof:type_name -> compose.Proof
	13, // 14: compose.Message.integrated_decided:type_name -> compose.IntegratedDecided
	14, // 15: compose.Message.ws_decided:type_name -> compose.WSDecided
