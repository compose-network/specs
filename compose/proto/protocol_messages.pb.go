...
type Message_NativeDecided struct {
	// CDCP
	NativeDecided *NativeDecided `protobuf:"bytes,14,opt,name=native_decided,json=nativeDecided,proto3,oneof"`
}
...
const file_protocol_messages_proto_rawDesc = "" +
	...
	"\vinstance_id\x18\x01 \x01(\fR\n" +
	"instanceId\x12\x1a\n" +
	"\bdecision\x18\x02 \x01(\bR\bdecision\"\xa9\x06\n" +
	"\aMessage\x12\x1b\n" +
	...
	"\x05proof\x18\r \x01(\v2\x0e.compose.ProofH\x00R\x05proof\x12?\n" +
	"\x0enative_decided\x18\x0e \x01(\v2\x16.compose.NativeDecidedH\x00R\rnativeDecided\x123\n" +
	"\n" +
...
var file_protocol_messages_proto_depIdxs = []int32{
	...
	13, // 14: compose.Message.native_decided:type_name -> compose.NativeDecided
